...
(1, 8, 'Calle 24 # 99 x 21 y 19 Col. Centro, Hoctún, Yucatán.', '+52 999 177 3532', 'ajal-lol@hotmail.com', 'Lun–Vie · 9:00 a.m. – 1:00 p.m.', '<iframe src=\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3728.1311582263615!2d-89.20769322688852!3d20.866763080742317!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f5691003bea8d97%3A0xc86a2696d1d97c7b!2sAjal-Lol%20A.C!5e0!3m2!1ses-419!2smx!4v1775672653034!5m2!1ses-419!2smx\" width=\"600\" height=\"450\" style=\"border:0;\" allowfullscreen=\"\" loading=\"lazy\" referrerpolicy=\"no-referrer-when-downgrade\"></iframe>', 'https://www.facebook.com/p/Ajal-Lol-AC-100064161455063/', 'https://www.instagram.com/ajal_lol/?hl=es-la', 'https://mx.linkedin.com/in/ajal-lol-a-c-103b811a0', 1);
...
(10, 'Rafael Sánchez Martín', 'admin@ajallol.com', '9991208921', 'Quiero colaborar', 'Hola quiero colaborar', '2026-04-07 11:33:31'),
(11, 'José Alfredo Muñoz Montenegro', 'alfredo2@gmail.com', '9991208924', 'Quiero colaborar con ustedes', 'Dame más información al respecto.', '2026-04-07 11:40:58'),
(12, 'Kevin DuBrow', 'Kevin@gmail.com', '9991208927', 'Quiero colaborar con conocimientos de medicina', 'Hay alguna manera de que pueda contactar con ustedes.', '2026-04-07 11:56:43');
...
(19, 1, 7, 'Nueva solicitud de: Enrique Sosa Canul', 'Participación en talleres — Estoy interesado en asistir a los talleres de capacitación. ¿Cómo me inscribo?', 1, '2026-02-27 20:00:00'),
...
(22, 1, 8, 'Nueva solicitud de: Lucía Balam Tun', 'Donación en especie — Me gustaría donar ropa y víveres en buen estado. ¿Cuál es el procedimiento?', 1, '2026-03-01 14:45:00'),
...
(28, 1, 10, 'Nueva solicitud de: Rafael Sánchez Martín', 'Quiero colaborar — Hola quiero colaborar', 0, '2026-04-07 17:33:31'),
(29, 5, 10, 'Nueva solicitud de: Rafael Sánchez Martín', 'Quiero colaborar — Hola quiero colaborar', 0, '2026-04-07 17:33:31'),
(30, 8, 10, 'Nueva solicitud de: Rafael Sánchez Martín', 'Quiero colaborar — Hola quiero colaborar', 0, '2026-04-07 17:33:31'),
(31, 1, 11, 'Nueva solicitud de: José Alfredo Muñoz Montenegro', 'Quiero colaborar con ustedes — Dame más información al respecto.', 0, '2026-04-07 17:40:58'),
(32, 5, 11, 'Nueva solicitud de: José Alfredo Muñoz Montenegro', 'Quiero colaborar con ustedes — Dame más información al respecto.', 0, '2026-04-07 17:40:58'),
(33, 8, 11, 'Nueva solicitud de: José Alfredo Muñoz Montenegro', 'Quiero colaborar con ustedes — Dame más información al respecto.', 0, '2026-04-07 17:40:58'),
(34, 1, 12, 'Nueva solicitud de: Kevin DuBrow', 'Quiero colaborar con conocimientos de medicina — Hay alguna manera de que pueda contactar con ustedes.', 0, '2026-04-07 17:56:43'),
(35, 5, 12, 'Nueva solicitud de: Kevin DuBrow', 'Quiero colaborar con conocimientos de medicina — Hay alguna manera de que pueda contactar con ustedes.', 0, '2026-04-07 17:56:43'),
(36, 8, 12, 'Nueva solicitud de: Kevin DuBrow', 'Quiero colaborar con conocimientos de medicina — Hay alguna manera de que pueda contactar con ustedes.', 0, '2026-04-07 17:56:43');
...
(306, 58, 'Carlos Eduardo Flores León', 'FOLC860118HYNLER07', 53, '2026-03-25 17:25:12'),
(307, 58, 'María Fernanda Gómez Ruiz', 'GORM910305MDFMGN06', 34, '2026-03-25 17:25:12'),
(308, 58, 'Gabriela Mendoza Paredes', 'MEPG980418MDFNRB16', 27, '2026-03-25 17:25:12'),
(309, 58, 'Miguel Ángel Navarro Ortiz', 'NAOM970214HDFVRT10', 29, '2026-03-25 17:25:12'),
(310, 58, 'Rodolfo Cabeza Navarrete Cab', 'NISJ850320HYNCSF01', 40, '2026-03-25 17:25:12'),
(311, 58, 'Juan Carlos Pérez López', 'PELJ880430HYNTRS03', 37, '2026-03-25 17:25:12'),
(312, 58, 'María Fernanda Ruiz Gómez', 'RUGM920804MYNRRM02', 32, '2026-03-25 17:25:12');
...
--
ALTER TABLE `notificaciones`
  MODIFY `id_notificacion` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `reportebeneficiarios`
  MODIFY `id_reportebeneficiario` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=313;

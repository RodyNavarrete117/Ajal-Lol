...
-- Versión mejorada: secciones_web → paginas (con ñ)
...
CREATE TABLE `paginas` (
  ...
  `plantilla`   varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'default' COMMENT 'Blade template',
  `activo`      tinyint(1)   NOT NULL DEFAULT '1',
  `orden`       int          NOT NULL DEFAULT '0',
  `meta_title`  varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'SEO title',
  `meta_desc`   varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'SEO description',
...
INSERT INTO `paginas` (`id_pagina`, `id_usuario`, `slug`, `titulo`, `plantilla`, `activo`, `orden`) VALUES
(1, 1, 'inicio',               'Inicio',               'inicio',      1, 1),
(2, 1, 'nosotros',             'Nosotros',             'nosotros',    1, 2),
(3, 1, 'aliados',              'Aliados',              'aliados',     1, 3),
(4, 1, 'actividades',          'Actividades',          'actividades', 1, 4),
(5, 1, 'proyectos',            'Proyectos',            'proyectos',   1, 5),
(6, 1, 'directiva',            'Directiva',            'directiva',   1, 6),
(7, 1, 'preguntas-frecuentes', 'Preguntas frecuentes', 'faq',         1, 7),
(8, 1, 'contacto',             'Contacto',             'contacto',    1, 8);

-- ============================================================
-- CONTENIDO WEB (id_seccion → id_pagina + activo)
-- ============================================================
...
-- Tiempo de generación: 26-03-2026 a las 16:23:22
...
INSERT INTO `paginas` (`id_pagina`, `id_usuario`, `slug`, `activo`, `orden`, `created_at`, `updated_at`) VALUES
(1, 1, 'inicio', 1, 1, '2026-03-26 16:18:54', '2026-03-26 16:18:54'),
(2, 1, 'nosotros', 1, 2, '2026-03-26 16:18:54', '2026-03-26 16:18:54'),
(3, 1, 'aliados', 1, 3, '2026-03-26 16:18:54', '2026-03-26 16:18:54'),
(4, 1, 'actividades', 1, 4, '2026-03-26 16:18:54', '2026-03-26 16:18:54'),
(5, 1, 'proyectos', 1, 5, '2026-03-26 16:18:54', '2026-03-26 16:18:54'),
(6, 1, 'directiva', 1, 6, '2026-03-26 16:18:54', '2026-03-26 16:18:54'),
(7, 1, 'preguntas-frecuentes', 1, 7, '2026-03-26 16:18:54', '2026-03-26 16:18:54'),
(8, 1, 'contacto', 1, 8, '2026-03-26 16:18:54', '2026-03-26 16:18:54');

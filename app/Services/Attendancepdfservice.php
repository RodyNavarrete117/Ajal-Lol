    ...
    public function generate(Report $report)
    {
            ...
            <table width="100%" style="border-bottom: 3px solid #783d66; padding-bottom: 10px; font-family: Arial, sans-serif;">
                <tr>
                    <td width="12%" style="vertical-align: middle;">
                        <img src="' . public_path('assets/img/logo_principal/ImagenPrincipal.jpg') . '" style="height: 70px;">
                    </td>
        ...
        <table class="meta-box">
            ...
            <tr>
                ...
                <td class="meta-value"><strong style="font-size:14px; color:#783d66;">' . $totalAsist . '</strong></td>
            </tr>' : '
            <tr>
                <td class="meta-label">Total asistentes</td>
                <td class="meta-value" colspan="3"><strong style="font-size:14px; color:#783d66;">' . $totalAsist . '</strong></td>
            </tr>') . '
        </table>

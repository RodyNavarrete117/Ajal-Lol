...
class BlankAttendancePdfService
{
        ...
        <table class="ben-table">
            <thead>
                <tr>
                    ...
                    <th style="width:160px;">Firma de asistencia</th>
                </tr>
            </thead>
            <tbody>';
    ...
    public function generateWithMeta(\App\Models\Report $report)
    {
        ...
        <style>
            body { font-family: Arial; font-size: 10px; }
            .section-title { background: #783d66; color: #fff; font-size: 10px; font-weight: bold; padding: 6px 10px; text-transform: uppercase; }
            .meta-box { width: 100%; border-collapse: collapse; margin-bottom: 8px; border: 1px solid #e0c8d8; }
            .meta-box td { padding: 6px 8px; border-bottom: 1px solid #f0e0ea; }
            .meta-label { font-weight: bold; color: #783d66; width: 130px; background: #fdf5fa; font-size: 8px; }
            .meta-value { font-size: 10px; color: #222; }
            .section-header { background: #783d66; color: #fff; font-size: 9px; font-weight: bold; padding: 5px 10px; text-transform: uppercase; }
            table.ben-table { width: 100%; border-collapse: collapse; }
            table.ben-table th { background: #f7edf4; color: #5a2d4d; font-size: 8px; padding: 4px; border: 1px solid #e0c8d8; }
            table.ben-table td { border: 1px solid #eedde8; height: 10mm; }
        ...
        <table class="meta-box">
            <tr>
                <td class="meta-label">Documento</td>
                <td class="meta-value">Registro de Asistencia</td>
                <td class="meta-label">Número de documento</td>
        ...
        for ($i = 1; $i <= 20; $i++) {
            $html .= '<tr><td class="num-cell">' . $i . '</td><td></td><td></td><td></td></tr>';
        }

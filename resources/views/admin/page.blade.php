    ...
    <div class="pages-list">
        ...
        <div class="page-item">
            ...
            <div class="page-content">
                ...
                <div class="page-description">Bienvenidos al portal informativo de Ajal Lol. Organización de Asistencia Social, sin fines de lucro.</div>
            </div>
        ...
        <div class="page-item">
            ...
            <div class="page-content">
                ...
                <div class="page-description">Conoce más sobre nosotros. La organización fue fundada en el año 2000 por 5 mujeres quienes compartían...</div>
            </div>
            <div class="page-actions">
                <button class="action-btn btn-edit" title="Editar">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="page-item">
            ...
            <div class="page-content">
                ...
                <div class="page-description">Formulario de contacto y datos de ubicación para que los usuarios se comuniquen con la organización.</div>
            </div>
            <div class="page-actions">
                <button class="action-btn btn-edit" title="Editar">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">

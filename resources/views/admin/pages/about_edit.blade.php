    ...
    <div class="edit-container">
        ...
        <div class="edit-form-body">
            <form method="POST" action="#" enctype="multipart/form-data">
                ...
                {{-- ══ SECCIÓN 2: Bloque historia (imagen + texto) ══ --}}
                <div class="form-section">
                    <div class="form-section-title">
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            ...
                            rows="4"
                            placeholder="Texto en cursiva que aparece resaltado con borde lateral..."
                        >{{ old('texto_destacado', 'La organización fue fundada en el año 2000 por 5 mujeres que compartían la inquietud de buscar una manera de ayudar a las personas de escasos recursos. Actualmente el comité directivo lo conforman 8 mujeres y su trabajo es apoyado por 35 colaboradores y voluntarios.') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            ...
                            rows="5"
                            placeholder="Texto explicativo más amplio sobre la organización..."
                        >{{ old('texto_descripcion', 'Para nosotros como asociación es muy importante el papel que jugamos en la sociedad. Siempre hemos buscado que nuestras acciones tengan un impacto positivo llegando al mayor número posible de beneficiarios.') }}</textarea>
                    </div>
                </div>
                ...
                {{-- ══ SECCIÓN 4: Identidad institucional ══ --}}
                <div class="form-section">
                    <div class="form-section-title">
                        ...
                        <div class="identity-card identity-card--mision">
                            ...
                            <div class="identity-card__body">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="titulo_mision" name="titulo_mision" value="{{ old('titulo_mision', 'Misión') }}" placeholder="Ej: Misión">
                                </div>
                                <div class="form-group">
                                    <label for="mision">Contenido</label>
                                    <textarea id="mision" name="mision" rows="4" placeholder="Impulsar programas que aporten positivamente...">{{ old('mision', 'Impulsar programas que aporten positivamente al desarrollo integral de las familias en situación vulnerable.') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="identity-card identity-card--vision">
                            ...
                            <div class="identity-card__body">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="titulo_vision" name="titulo_vision" value="{{ old('titulo_vision', 'Visión') }}" placeholder="Ej: Visión">
                                </div>
                                <div class="form-group">
                                    <label for="vision">Contenido</label>
                                    <textarea id="vision" name="vision" rows="4" placeholder="Ser un referente a nivel nacional...">{{ old('vision', 'Ser un referente a nivel nacional como organización que apoya el desarrollo integral en materia de salud y capacitación para el trabajo.') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="identity-card identity-card--objetivo">
                            ...
                            <div class="identity-card__body">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="titulo_objetivo" name="titulo_objetivo" value="{{ old('titulo_objetivo', 'Objetivo General') }}" placeholder="Ej: Objetivo General">
                                </div>
                                <div class="form-group">
                                    <label for="objetivo_general">Contenido</label>
                                    <textarea id="objetivo_general" name="objetivo_general" rows="4" placeholder="Contribuir al mejoramiento de la calidad de vida...">{{ old('objetivo_general', 'Contribuir al mejoramiento de la calidad de vida de las personas que viven en situación vulnerable de las comunidades mayas de Yucatán.') }}</textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    {{-- Encabezado de la sección identidad --}}
                    <div class="identity-header-fields">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    type="text"
                                    id="identidad_subtitulo"
                                    name="identidad_subtitulo"
